...
<?php 
    // 1. FIRST: Handle the logic to update or delete
    if(isset($_GET['status'])){
        ...
        // This redirect is the secret to fixing the "double click"
        // It reloads the page automatically after the database is updated.
        echo "<script>window.location.href='manage_cata.php'</script>";
    }

    // 2. SECOND: Now fetch the updated data
