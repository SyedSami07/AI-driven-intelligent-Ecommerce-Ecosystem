            ...
            <div class="contain-product deal-layout contain-product__deal-layout">
                ...
                <div class="info">
                    ...
                    <div class="price ">
                        ...
                        <del><span class="price-amount"><span class="currencySymbol">৳</span>90.00</span></del>
                    </div>
                    <div class="slide-down-box">
                        ...
                        <div class="buttons">
                            ...
                            <form action="#" method="POST" style="display:inline-block;">
                                <input type="hidden" name="pdt_name" value="National Fresh Fruit">
                                <input type="hidden" name="pdt_price" value="85.00">
                                <input type="hidden" name="pdt_img" value="product_deal_330x330.jpg">
                                <input type="hidden" name="pdt_id" value="101">
                                <input type="submit" class="btn add-to-cart-btn" value="Add To Cart" name="addtocart">
                            </form>
                    ...
                    <div class="slide-down-box">
                        ...
                        <div class="buttons">
                            ...
                            <form action="#" method="POST" style="display:inline-block;">
                                <input type="hidden" name="pdt_name" value="National Fresh Fruit">
                                <input type="hidden" name="pdt_price" value="85.00">
                                <input type="hidden" name="pdt_img" value="product_deal-02_330x330.jpg">
                                <input type="hidden" name="pdt_id" value="102">
                                <input type="submit" class="btn add-to-cart-btn" value="Add To Cart" name="addtocart">
                            </form>
                ...
                <div class="info">
                    ...
                    <div class="slide-down-box">
                        ...
                        <div class="buttons">
                            ...
                            <form action="#" method="POST" style="display:inline-block;">
                                <input type="hidden" name="pdt_name" value="National Fresh Fruit">
                                <input type="hidden" name="pdt_price" value="45.00">
                                <input type="hidden" name="pdt_img" value="product_deal-03_330x330.jpg">
                                <input type="hidden" name="pdt_id" value="103">
                                <input type="submit" class="btn add-to-cart-btn" value="Add To Cart" name="addtocart">
                            </form>
