    ...
    <div class="page-contain">
        <div id="main-content" class="main-content">
            <div class="container">
                ...
                <div class="registration-msg-container text-center" style="margin-bottom: 30px;">
                    <?php if (isset($reg_msg)): ?>
                        <h4 class="alert <?php echo (strpos($reg_msg, 'successful') !== false) ? 'alert-success' : 'alert-danger'; ?>" style="display: inline-block; padding: 15px 25px;">
                            <?php echo $reg_msg; ?>
                        </h4>

                        <?php if (strpos($reg_msg, 'successful') !== false): ?>
                            <div style="margin-top: 15px;">
                                <p style="color: #666;">Didn't get the email? Link expires in 2 minutes.</p>
                                <a href="resend_verification.php" class="btn btn-warning" style="color: #000; font-weight: bold; padding: 10px 20px;">
                        ...
                        <div class="signin-container">
                            <form action="" name="frm-register" method="POST">
                                ...
                                <p class="form-row">
                                    ...
                                    <textarea name="user_address" id="" cols="10" class="form-control" required></textarea>
                                </p>
